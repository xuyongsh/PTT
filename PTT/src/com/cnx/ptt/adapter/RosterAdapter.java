...
import com.cnx.ptt.chat.iphonetreeview.IphoneTreeView.IphoneTreeHeaderAdapter;
...
public class RosterAdapter extends BaseExpandableListAdapter implements
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.c_contact_buddy_list_group,
					null);
		}
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		if (convertView == null
			...
			L.i("david xu", "new  child ");
			holder = new ViewHolder();
			convertView = mInflater.inflate(
					R.layout.c_contact_list_item_for_buddy, parent, false);
			...
			L.i("david xu", "get child form case");
	...
	public int getTreeHeaderState(int groupPosition, int childPosition) {
		...
		if (childPosition == childCount - 1) {
			...
			L.i("david xu", "groupPosition = " + groupPosition
