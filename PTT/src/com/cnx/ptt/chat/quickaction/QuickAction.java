package com.cnx.ptt.chat.quickaction;
...
public class QuickAction extends PopupWindows implements OnDismissListener {
	...
	public QuickAction(Context context, int orientation) {
		...
		if (mOrientation == HORIZONTAL) {
			setRootViewId(R.layout.c_popup_horizontal);
		} else {
			setRootViewId(R.layout.c_popup_vertical);
		}
	...
	public void addActionItem(ActionItem action) {
		...
		if (mOrientation == HORIZONTAL) {
			container = mInflater
					.inflate(R.layout.c_action_item_horizontal, null);
		} else {
			container = mInflater.inflate(R.layout.c_action_item_vertical, null);
		}
		...
		if (mOrientation == HORIZONTAL && mChildPos != 0) {
			View separator = mInflater.inflate(R.layout.c_horiz_separator, null);
