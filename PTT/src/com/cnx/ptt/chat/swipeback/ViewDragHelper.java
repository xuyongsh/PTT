...
package com.cnx.ptt.chat.swipeback;
...
public class ViewDragHelper {
	 ...
	 * callback's
	 * {@link com.cnx.ptt.chat.swipeback.ViewDragHelper.Callback#onEdgeTouched(int, int)}
	 * and
	 * {@link com.cnx.ptt.chat.swipeback.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
	 ...
	 * {@link com.cnx.ptt.chat.swipeback.ViewDragHelper.Callback#tryCaptureView(android.view.View, int)}
	 ...
	 * {@link com.cnx.ptt.chat.swipeback.ViewDragHelper.Callback#getOrderedChildIndex(int)}
	 * .
	 * 
	 * @param x
	 *            X position to test in the parent's coordinate system
