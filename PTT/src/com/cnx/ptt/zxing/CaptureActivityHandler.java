...
public class CaptureActivityHandler extends Handler {
	...
	public CaptureActivityHandler(CaptureCodeActivity captureCodeActivity,
			Collection<BarcodeFormat> decodeFormats,
			Map<DecodeHintType, ?> decodeHints, String characterSet,
			CameraManager cameraManager) {
		this.activity = captureCodeActivity;
		decodeThread = new DecodeThread(captureCodeActivity, decodeFormats,
				decodeHints, characterSet, new ViewfinderResultPointCallback(
...
//					R.id.decode);
	...
	public CaptureCodeActivity getActivity() {
		return activity;
	}
